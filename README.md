...
Customer status segmentation (Active/ At Risk/ Churned)

Revenue impact analysis

KPI design (Churn Rate, Revenue Drop, Retention Priority Score)
...
Payment-to-Charge Ratio analysis

Cost variability across states and hospital types
